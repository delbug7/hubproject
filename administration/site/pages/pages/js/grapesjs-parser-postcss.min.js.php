...
!function (t, e) {
    ...
    return function (t) {
        ...
        var u = function () {
            ...
            return t.prototype.error = function (t) {
                ...
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e = function t(e, r) {
                    var o = new e.constructor;
                    for (var i in e) if (e.hasOwnProperty(i)) {
                        var s = e[i], a = void 0 === s ? "undefined" : n(s);
                ...
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e = this.clone(t);
                ...
                var t = {};
                for (var e in this) if (this.hasOwnProperty(e) && "parent" !== e) {
                    var r = this[e];
        ...
        (function (t) {
            ...
            e.resolve = function () {
                ...
                for (var o = n(t.split("/")), i = n(r.split("/")), s = Math.min(o.length, i.length), a = s, u = 0; u < s; u++) if (o[u] !== i[u]) {
                    a = u;
                    break
                }
                var l = [];
        ...
        e.default = function (t, e) {
            var r = new o.default(t, e), i = new n.default(r);
            try {
                i.parse()
            } catch (t) {
                throw t
        ...
        var a = function (t) {
            ...
            return function (t, e) {
                ...
                for (n = o ? n : n[Symbol.iterator](); ;) {
                    ...
                    var a = s, u = this.normalize(a, this.last), l = Array.isArray(u), c = 0;
                ...
                for (var t = arguments.length, e = Array(t), r = 0; r < t; r++) e[r] = arguments[r];
                var n = e = e.reverse(), o = Array.isArray(n), i = 0;
                for (n = o ? n : n[Symbol.iterator](); ;) {
                    var s;
                    if (o) {
                        if (i >= n.length) break;
                    ...
                    var a = s, u = this.normalize(a, this.first, "prepend").reverse(), l = u, c = Array.isArray(l),
                        f = 0;
                ...
                var r = 0 === (t = this.index(t)) && "prepend", n = this.normalize(e, this.nodes[t], r).reverse(),
                    o = n, i = Array.isArray(o), s = 0;
                ...
                t = this.index(t);
                var r = this.normalize(e, this.nodes[t]).reverse(), n = r, o = Array.isArray(n), i = 0;
                for (n = o ? n : n[Symbol.iterator](); ;) {
                    var s;
                    if (o) {
                        if (i >= n.length) break;
                ...
                var t = this.nodes, e = Array.isArray(t), r = 0;
                ...
                }(r(5)(t).nodes); else if (Array.isArray(t)) {
        ...
        "use strict";
        e.__esModule = !0;
        var n = s(r(24)), o = s(r(25)), i = s(r(26));
        ...
        var a = function () {
            ...
            return t.prototype.setMessage = function () {
                ...
                var s = r.split(/\r?\n/), a = Math.max(this.line - 3, 0), u = Math.min(this.line + 2, s.length),
                    l = String(u).length;
        ...
        var o = function () {
            ...
            return t.prototype.stringify = function (t, e) {
                ...
                var e = this.raw(t, "left", "commentLeft"), r = this.raw(t, "right", "commentRight");
                this.builder("/*" + e + t.text + r + "*/", t)
            }, t.prototype.decl = function (t, e) {
                var r = this.raw(t, "between", "colon"), n = t.prop + r + this.rawValue(t, "value");
                ...
                var r = "@" + t.name, n = t.params ? this.rawValue(t, "params") : "";
                ...
                for (var r = this.raw(t, "semicolon"), n = 0; n < t.nodes.length; n++) {
                    var o = t.nodes[n], i = this.raw(o, "before");
        ...
        var i = function () {
            ...
            return t.prototype.use = function (t) {
                ...
                var e = [], r = t, o = Array.isArray(r), i = 0;
                for (r = o ? r : r[Symbol.iterator](); ;) {
                    ...
                    var a = s;
                    if (a.postcss && (a = a.postcss), "object" === (void 0 === a ? "undefined" : n(a)) && Array.isArray(a.plugins)) e = e.concat(a.plugins); else if ("function" == typeof a) e.push(a); else {
        ...
        var n = function () {
            ...
            return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
        }, i = l(r(27)), s = l(r(3)), a = (l(r(39)), l(r(40))), u = l(r(5));
        ...
        var f = function () {
            function t(e, r, n) {
                ...
                var i = void 0;
                if ("object" === (void 0 === r ? "undefined" : o(r)) && null !== r && "root" === r.type) i = r; else if (r instanceof t || r instanceof a.default) i = r.root, r.map && (void 0 === n.map && (n.map = {}), n.map.inline || (n.map.inline = !1), n.map.prev = r.map); else {
                    var s = u.default;
            ...
            return t.prototype.warnings = function () {
                ...
                var t = this.result.processor.plugins, e = Array.isArray(t), r = 0;
                for (t = e ? t : t[Symbol.iterator](); ;) {
                    var n;
                    if (e) {
                        if (r >= t.length) break;
                ...
                var t = this.result.opts, e = s.default;
     ...
     */
            ...
            function f(t, e) {
                if (c(e), t = a(t, e < 0 ? 0 : 0 | h(e)), !u.TYPED_ARRAY_SUPPORT) for (var r = 0; r < e; ++r) t[r] = 0;
                return t
            }
            ...
            function m(t, e, r, n, o) {
                ...
                if (o) {
                    var c = -1;
                    for (i = r; i < a; i++) if (l(t, i) === l(e, -1 === c ? 0 : i - c)) {
                        if (-1 === c && (c = i), i - c + 1 === u) return c * s
                    } else -1 !== c && (i -= i - c), c = -1
                } else for (r + u > a && (r = a - u), i = r; i >= 0; i--) {
                    for (var f = !0, p = 0; p < u; p++) if (l(t, i + p) !== l(e, p)) {
                        f = !1;
                        break
                    }
                    if (f) return i
            ...
            function E(t, e, r) {
                ...
                for (var n = [], o = e; o < r;) {
                    var i, s, a, u, l = t[o], c = null, f = l > 239 ? 4 : l > 223 ? 3 : l > 191 ? 2 : 1;
                    if (o + f <= r) switch (f) {
                        case 1:
                            l < 128 && (c = l);
                            break;
            ...
            e.Buffer = u, e.SlowBuffer = function (t) {
                ...
                for (var i = o - n, s = r - e, a = Math.min(i, s), l = this.slice(n, o), c = t.slice(e, r), f = 0; f < a; ++f) if (l[f] !== c[f]) {
                    i = l[f], s = c[f];
                    break
                }
        ...
        var n = r(17), o = r(0), i = r(18).ArraySet, s = r(33).MappingList;
        ...
        a.prototype._version = 3, a.fromSourceMap = function (t) {
            var e = t.sourceRoot, r = new a({file: t.file, sourceRoot: e});
            ...
            var e = o.getArg(t, "generated"), r = o.getArg(t, "original", null), n = o.getArg(t, "source", null),
            ...
            this._mappings.unsortedForEach(function (e) {
                if (e.source === n && null != e.originalLine) {
                    var i = t.originalPositionFor({line: e.originalLine, column: e.originalColumn});
            ...
            for (var t, e, r, i, s = 0, a = 1, u = 0, l = 0, c = 0, f = 0, p = "", h = this._mappings.toArray(), d = 0, g = h.length; d < g; d++) {
                if (t = "", (e = h[d]).generatedLine !== a) for (s = 0; e.generatedLine !== a;) t += ";", a++; else if (d > 0) {
        ...
        var n = r(0), o = Object.prototype.hasOwnProperty, i = "undefined" != typeof Map;
        ...
        s.fromArray = function (t, e) {
            ...
            var r = i ? t : n.toSetString(t), s = i ? this.has(t) : o.call(this._set, r), a = this._array.length;
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: !0}), e.createAtRule = e.createRule = e.log = void 0;
        var n = Object.assign || function (t) {
            for (var e = 1; e < arguments.length; e++) {
                var r = arguments[e];
                for (var n in r) Object.prototype.hasOwnProperty.call(r, n) && (t[n] = r[n])
        ...
        var i = e.log = function (t, e) {
            return t && t.log(e, {ns: "parser-poscss"})
        }, s = e.createRule = function (t) {
            var e = {};
            return (t.nodes || []).forEach(function (t) {
                var r = t.prop, n = t.value, o = t.important;
                e[r] = n + (o ? " !important" : "")
            }), {selectors: t.selector || "", style: e}
        }, a = e.createAtRule = function (t, e) {
            var r = t.name, o = t.params;
            ["media", "keyframes"].indexOf(r) >= 0 ? t.nodes.forEach(function (t) {
                e.push(n({}, s(t), {atRule: r, params: o}))
            }) : e.push(n({}, s(t), {atRule: r}))
        };
        e.default = function (t, e) {
            var r = [];
            i(e, ["Input CSS", t]);
        ...
        "use strict";
        e.__esModule = !0;
        var n = h(r(1)), o = h(r(12)), i = h(r(3)), s = h(r(6)), a = h(r(7)), u = h(r(47)), l = h(r(5)), c = h(r(19)),
            f = h(r(9)), p = h(r(20));
        ...
        (function (n) {
            ...
            var a = function () {
                ...
                return t.prototype.isMap = function () {
                    ...
                    if (!1 !== this.mapOpts.annotation) for (var t = void 0, e = this.root.nodes.length - 1; e >= 0; e--) "comment" === (t = this.root.nodes[e]).type && 0 === t.text.indexOf("# sourceMappingURL=") && this.root.removeChild(e)
                    ...
                    var t = this.previous(), e = Array.isArray(t), r = 0;
                    for (t = e ? t : t[Symbol.iterator](); ;) {
                        var n;
                        if (e) {
                            if (r >= t.length) break;
                        ...
                        var s = n, a = this.relative(s.file), u = s.root || i.default.dirname(s.file), l = void 0;
                    ...
                    var t = this;
                    this.css = "", this.map = new o.default.SourceMapGenerator({file: this.outputFile()});
                    var e = 1, r = 1, n = void 0, i = void 0;
        ...
        e.read = function (t, e, r, n, o) {
            var i, s, a = 8 * o - n - 1, u = (1 << a) - 1, l = u >> 1, c = -7, f = r ? o - 1 : 0, p = r ? -1 : 1,
                h = t[e + f];
            ...
            var s, a, u, l = 8 * i - o - 1, c = (1 << l) - 1, f = c >> 1,
        ...
        o.prototype.unsortedForEach = function (t, e) {
            ...
            !function (t, e) {
                var r = t.generatedLine, o = e.generatedLine, i = t.generatedColumn, s = e.generatedColumn;
        ...
        var n = r(0), o = r(35), i = r(18).ArraySet, s = r(17), a = r(36).quickSort;
        ...
        function l(t, e) {
            ...
            var o = n.getArg(r, "version"), s = n.getArg(r, "sources"), a = n.getArg(r, "names", []),
                u = n.getArg(r, "sourceRoot", null), l = n.getArg(r, "sourcesContent", null),
                c = n.getArg(r, "mappings"), f = n.getArg(r, "file", null);
        ...
        function f(t, e) {
            ...
            this._sections = s.map(function (t) {
                ...
                var r = n.getArg(t, "offset"), o = n.getArg(r, "line"), i = n.getArg(r, "column");
        ...
        u.fromSourceMap = function (t, e) {
            ...
            var e = n.getArg(t, "line"),
                r = {source: n.getArg(t, "source"), originalLine: e, originalColumn: n.getArg(t, "column", 0)};
            ...
            if (s >= 0) {
                ...
                if (void 0 === t.column) for (var u = a.originalLine; a && a.originalLine === u;) i.push({
                    line: n.getArg(a, "generatedLine", null),
                    column: n.getArg(a, "generatedColumn", null),
                    lastColumn: n.getArg(a, "lastGeneratedColumn", null)
                }), a = this._originalMappings[++s]; else for (var l = a.originalColumn; a && a.originalLine === e && a.originalColumn == l;) i.push({
                    line: n.getArg(a, "generatedLine", null),
                    column: n.getArg(a, "generatedColumn", null),
                    lastColumn: n.getArg(a, "lastGeneratedColumn", null)
            ...
            for (e = 0; e < this._absoluteSources.length; ++e) if (this._absoluteSources[e] == t) return e;
            return -1
        }, l.fromSourceMap = function (t, e) {
            var r = Object.create(l.prototype), o = r._names = i.fromArray(t._names.toArray(), !0),
            ...
            for (var r, o, i, u, l, f = 1, p = 0, h = 0, d = 0, g = 0, y = 0, m = t.length, v = 0, w = {}, b = {}, _ = [], A = []; v < m;) if (";" === t.charAt(v)) f++, v++, p = 0; else if ("," === t.charAt(v)) v++; else {
                for ((r = new c).generatedLine = f, u = v; u < m && !this._charIsMappingSeparator(t, u); u++) ;
                if (i = w[o = t.slice(v, u)]) v += o.length; else {
            ...
            if ((e = this._findSourceIndex(e)) < 0) return {line: null, column: null, lastColumn: null};
            var r = {source: e, originalLine: n.getArg(t, "line"), originalColumn: n.getArg(t, "column")},
            ...
            get: function () {
                for (var t = [], e = 0; e < this._sections.length; e++) for (var r = 0; r < this._sections[e].consumer.sources.length; r++) t.push(this._sections[e].consumer.sources[r]);
                return t
            }
            ...
            for (var r = 0; r < this._sections.length; r++) for (var o = this._sections[r], i = o.consumer._generatedMappings, s = 0; s < i.length; s++) {
                var u = i[s], l = o.consumer._sources.at(u.source);
        ...
        e.GREATEST_LOWER_BOUND = 1, e.LEAST_UPPER_BOUND = 2, e.search = function (t, r, n, o) {
            ...
            var i = function t(r, n, o, i, s, a) {
                var u = Math.floor((n - r) / 2) + r, l = s(o, i[u], !0);
        ...
        var n = r(16).SourceMapGenerator, o = r(0), i = /(\r?\n)/, s = "$$$isSourceNode$$$";
        ...
        a.fromStringWithSourceMap = function (t, e, r) {
            var n = new a, s = t.split(i), u = 0, l = function () {
                return t() + (t() || "");
            ...
            function h(t, e) {
                if (null === t || void 0 === t.source) n.add(e); else {
            ...
            var e = {code: "", line: 1, column: 0}, r = new n(t), o = !1, i = null, s = null, a = null, u = null;
        ...
        "use strict";
        e.__esModule = !0;
        var n = l(r(1)), o = l(r(43)), i = l(r(6)), s = l(r(7)), a = l(r(20)), u = l(r(9));
        ...
        var c = function () {
            ...
            return t.prototype.createTokenizer = function () {
                ...
                for (var e = 0, r = void 0, n = void 0, o = void 0, i = 0; i < t.length; i++) {
                    if ("(" === (n = (r = t[i])[0])) e += 1; else if (")" === n) e -= 1; else if (0 === e && ":" === n) {
                        if (o) {
            ...
            }, t.prototype.precheckMissedSemicolon = function () {
        ...
        "use strict";
        e.__esModule = !0, e.default = function (t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r = t.css.valueOf(),
                O = e.ignoreErrors, M = void 0, x = void 0, R = void 0, k = void 0, P = void 0, L = void 0, T = void 0,
                B = void 0, j = void 0, U = void 0, I = void 0, D = void 0, N = void 0, F = void 0, Y = r.length,
                z = -1, G = 1, $ = 0, V = [], W = [];
        ...
        var n = 39, o = 34, i = 92, s = 47, a = 10, u = 32, l = 12, c = 9, f = 13, p = 91, h = 93, d = 40, g = 41,
            y = 123, m = 125, v = 59, w = 42, b = 58, _ = 64, A = /[ \n\t\r\f{}()'"\\;/[\]#]/g,
            S = /[ \n\t\r\f(){}:;@!'"\\\][#]|\/(?=\*)/g, C = /.[\\/("'\n]/, E = /[a-f0-9]/i;
        t.exports = e.default
    }, function (t, e, r) {
        "use strict";
        ...
        var l = 0, c = function () {
            ...
            return t.prototype.error = function (t, e, r) {
                var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {}, o = void 0,
                    s = this.origin(e, r);
                ...
                var r = this.map.consumer(), n = r.originalPositionFor({line: t, column: e});
        ...
        (function (n) {
            ...
            var l = function () {
                function t(e, r) {
                    ...
                    var n = r.map ? r.map.prev : void 0, o = this.loadMap(r.from, n);
                    o && (this.text = o)
                }
