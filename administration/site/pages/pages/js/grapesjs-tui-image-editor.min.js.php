    ...
    return function (t) {
        ...
        e.default = function (t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                }, e), i = o.script, c = o.style, s = o.height, u = o.width, l = o.hideHeader, d = o.icons, p = o.onApply,
                f = o.upload, m = o.addToAssets, g = o.commandId, h = function () {
            ...
            var j = t.DomComponents, w = j.getType("image").model;
            j.addType("image", {
                model: {
                    initToolbar: function () {
                        w.prototype.initToolbar.apply(this, arguments);
                        var t = this.get("toolbar");
                        t.some(function (t) {
                            return t.command === g
                        }) || (t.unshift({command: g, label: o.toolbarIcon}), this.set("toolbar", t))
                    }
                }
            }), t.Commands.add(g, {
                run: function (t, e) {
                    var n = this, r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, i = this.id;
                    if (!b) return t.log("TOAST UI Image editor not found", {level: "error", ns: g}), t.stopCommand(i);
                    this.editor = t, this.target = r.target || t.getSelected();
                    var a = this.createContent(), c = o.labelImageEditor, s = a.children[1];
                    t.Modal.open({title: c, content: a}).getModel().once("change:open", function () {
                        return t.stopCommand(i)
                    }), this.imageEditor = new b(a.children[0], this.getEditorConfig()), t.getModel().setEditing(1), s.onclick = function () {
                    ...
                    if (p) p(e, n); else {
                        ...
                        if (f) {
                            ...
                            o.FileUploader().uploadFile({dataTransfer: {files: [i]}}, function (e) {
                                var n = e && e.data && e.data[0], o = n && ("string" == typeof n ? n : n.src);
                                o && t.applyToTarget(o)
                            })
                        } else m && o.add({src: r, name: (n.get("src") || "").split("/").pop()}), this.applyToTarget(r)
                    }
