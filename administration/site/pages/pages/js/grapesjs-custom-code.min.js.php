...
define('_HUBACCES', 1);
$rootPath  = __DIR__;
$rootPath = str_replace('administration/site/pages/pages/js', '', $rootPath);
require_once $rootPath. 'administration' .DIRECTORY_SEPARATOR. 'requires' .DIRECTORY_SEPARATOR. 'defined.php';
require_once $rootPath. 'administration' .DIRECTORY_SEPARATOR. 'app' .DIRECTORY_SEPARATOR. 'class' .DIRECTORY_SEPARATOR. 'autoloader.php';
Autoloader::register();
?>
    ...
    return function (e) {
        ...
        t.default = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, o = n({
                blockLabel: "<?= \Administration\app\Language::getLanguage($_SESSION['language'])["GRAPESJS_CUSTOM_CODE_TITLE"] ?>",
                blockCustomCode: {},
                propsCustomCode: {},
                placeholderContent: "<span><?= \Administration\app\Language::getLanguage($_SESSION['language'])["GRAPESJS_CUSTOM_CODE_INSERT"] ?></span>",
                ...
                modalTitle: "<?= \Administration\app\Language::getLanguage($_SESSION['language'])["GRAPESJS_CUSTOM_CODE_INSERT"] ?>",
                codeViewOptions: {},
                buttonLabel: "Save",
                commandCustomCode: {}
            }, t);
