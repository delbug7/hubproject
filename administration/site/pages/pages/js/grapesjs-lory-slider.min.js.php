...
!function (e, t) {
    ...
    return function (e) {
        ...
        var a = Object.assign || function (e) {
            ...
            return e
        }, r = l(3), n = s(r), d = l(4), i = s(d), o = l(11), u = s(o);
        ...
        Object.defineProperty(t, "__esModule", {value: !0});
        var a = l(0), r = s(a), n = l(5), d = s(n), i = l(6), o = s(i), u = l(7), p = s(u), c = l(8), f = s(c),
            v = l(9), m = s(v), y = l(10), g = s(y);
        t.default = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, l = e.DomComponents,
                s = l.getType("default");
        ...
        t.default = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, l = e.getType("default"),
                a = l.model, n = l.view, d = r.default.frameName, i = r.default.prevSelector,
                o = r.default.nextSelector, u = r.default.sliderName, p = r.default.slidesName, c = r.default.prevName,
                f = r.default.nextName, v = r.default.sliderId;
                ...
                model: a.extend({
                    defaults: s({}, a.prototype.defaults, {
                        ...
                        traits: [{
                            ...
                            name: "infinite",
                            changeProp: 1
                        }, {type: "checkbox", label: "Rewind", name: "rewind", changeProp: 1}, {
                            type: "number",
                            label: "Slide speed",
                            name: "slide-speed",
                            changeProp: 1
                        ...
                        script: function () {
                            var e = this, t = "{[ script-deps ]}", l = ["0", "false"], s = "{[ infinite ]}";
        ...
        t.default = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, l = e.getType("default"),
                a = l.model, d = r.default.slidesName, i = (r.default.slidesId, r.default.slideSelector),
        ...
        t.default = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, l = e.getType("default"),
                a = l.model, d = l.view, i = r.default.slideName, o = (r.default.slideId, r.default.slidesSelector);
            e.addType(i, {
                model: a.extend({
                    defaults: s({}, a.prototype.defaults, {
                        name: "Slide",
        ...
        t.default = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, l = e.getType("default"),
                a = l.model, d = r.default.prevName, i = (r.default.prevId, r.default.sliderSelector), o = t.classPrev,
                u = d;
            e.addType(u, {
                model: a.extend({
                    defaults: s({}, a.prototype.defaults, {
        ...
        t.default = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, l = e.getType("default"),
                a = l.model, d = r.default.nextName, i = (r.default.nextId, r.default.sliderSelector), o = t.classNext,
                u = d;
            e.addType(u, {
                model: a.extend({
                    defaults: s({}, a.prototype.defaults, {
        ...
        t.default = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, l = e.getType("default"),
                a = l.model, d = l.view, i = r.default.frameName, o = (r.default.frameId, r.default.slidesSelector);
            e.addType(i, {
                model: a.extend({
                    defaults: s({}, a.prototype.defaults, {
                        name: "Slider Frame",
        ...
        t.default = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, l = e.BlockManager,
                a = t.sliderBlock, n = r.default.sliderName;
            a && l.add(n, s({
